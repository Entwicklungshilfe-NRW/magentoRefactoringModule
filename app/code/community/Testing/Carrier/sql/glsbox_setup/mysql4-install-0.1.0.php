...
//-- DROP TABLE IF EXISTS {$this->getTable('shipment')};
//-- DROP TABLE IF EXISTS {$this->getTable('client')};

$installer->run("
CREATE TABLE IF NOT EXISTS {$this->getTable('Testing_Carrier_shipment')} (
...
CREATE TABLE IF NOT EXISTS {$this->getTable('Testing_Carrier_client')} (
