 ...
 * @package    Testing_Carrier
 */
class Testing_Carrier_Model_Label_Item_Datamatrix
{
	public $dimension;
	public $border;
	...
	public function __construct() {
		$this->dimension = null;
		$this->border = false; //default ohne Border
	}
	
	public function setDimension($val) { $this->dimension = $val; return $this; }
	public function setBorder($val) { $this->border = $val; return $this; }
    ...
    static public function gd($res, $color, $x, $y, $angle, $type, $datas, $width = null, $height = null){
      return self::_draw($res, $color, $x, $y, $angle, $type, $datas, $width, $height);
    }
    
    static private function _draw($res, $color, $x, $y, $angle, $type, $datas, $width, $height){
      $digit = '';
      $hri   = '';
      $code  = '';
      $crc   = true;
