 ...
 * @package    Testing_Carrier
 */
class Testing_Carrier_Model_Unibox_Parser {
	...
	private function createGlsSubmitTag($service,$shipment,$weight,$shipfrom,$extra){
		...
		$tags=array(
			...
			'T051' => 'V '.Mage::getConfig()->getModuleConfig("Testing_Carrier")->version.'.'.Mage::getVersion(),		//Softwareversion (Modulversion&Magentoversion bsp: 0.0.2.1.7.2)
